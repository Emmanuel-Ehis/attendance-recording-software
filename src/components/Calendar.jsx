...
{ date: '2023-09-22', name: 'Class A_FRI' },
  ];
    ...
    <div className="grid grid-cols-7 gap-4 p-8 shadow-md md:ml-[4rem]">
      ...
      {daysOfMonth.map((day) => {
        ...
        if (dayOfWeek > 0 && dayOfWeek < 6) {
          return (
            <div key={formattedDay} className="p-2 text-center border border-red">
          ...
          return <div key={formattedDay} className="p-2 text-center border border-gray-300" />;
        }
      })}
    </div>
  );
